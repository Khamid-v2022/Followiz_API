...
S2.define('select2/defaults',[
  ...
  Defaults.prototype.reset = function () {
    ...
    function matcher (params, data) {
      ...
      var original = stripDiacritics(data.text).toUpperCase().replace('-', '').replace('  ', ' ');
      var term = stripDiacritics(params.term).toUpperCase().replace('-', '').replace('  ', ' ');  
...
// custome code source https://github.com/select2/select2/issues/3472#issuecomment-132246474
